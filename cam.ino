...
// Flask server endpoint (update with your computer’s local IP)
const char* serverName = "http://192.168.16.189:5000/upload";
...
unsigned long interval = 10000; // Send photo every 10 seconds
...
void sendPhoto() {
  ...
  int totalLength = startRequest.length() + fb->len + endRequest.length();
